## SyllabusAI
An AI-powered syllabus parser that extracts deadlines, assignments, and exam dates from course PDFs and generates a personalized study schedul, built with Claude API and deployed as a Streamlit web app.
